...
from . models import Cart, Payment, Product,Customer, Wishlist
...
class checkout(View):
    def get(self,request):
        ...
        paypalamount = float(totalamount/18.10)

        data ={"amount":paypalamount, "currency":"USD","receipt":"order_rcptid_12"}
